...
public class DriverClass {
	...
	public static void main(String[] args) {
        ...
        Ktp rena = new Ktp("2016103703", "Rena putri", "Mojokerto, 14-April-1998", "Perempuan", 2, 1, "Kutoporong", "Bangsal", "ISLAM", "Menikah","Mahasiswa", "WNI");
		Ktp wicak = new Ktp("2016103403", "Wicaksono Prawiro", "Mojokerto, 17-Januari-1991", "Laki-Laki", 1, 2, "Jabon", "Mojoanyar", "ISLAM", "Menikah","Wiraswasta", "WNI");
		Ktp kevin = new Ktp("2016103503", "Kevin Adinata", "Bandung, 15-Oktober-1997", "Laki-Laki", 2, 9, "Gayam", "Bangsal", "ISLAM", "Belum Menikah","PNS", "WNI");
		Ktp finis = new Ktp("2016103603", "Finishtri Demiasih", "Aceh, 15-Mei-1994", "Perempuan", 3, 5, "Gebangmalang", "Mojoanyar", "ISLAM", "Cerai","Wiraswasta", "WNI");
		Ktp ou = new Ktp("2016103803", "Ourievia Stevani", "Sidoarjo, 6-Februari-1993", "Perempuan", 4, 4, "Bukittinggi", "Banuhampu", "ISLAM", "Menikah","Ibu rumah tangga", "WNI");
		Ktp gladis = new Ktp("2016103903", "Gladiska Fristia", "Trenggalek, 28-Februari-1991", "Perempuan", 5, 3, "PandaiSingkek", "Kubang Putiah", "ISLAM", "Belum Menikah","Mahasiswa", "WNI");
		Ktp ray = new Ktp("2016103104", "Rayhan", "Cipanas, 8-Maret-1995", "Laki-Laki", 6, 8, "Tirto", "Landungsari", "ISLAM", "Belum Menikah","Mahasiswa", "WNI");
		Ktp nia = new Ktp("2016110330", "Nia Dwi", "Balikpapan, 19-Oktober-1997", "Perempuan", 7, 5, "Jone", "Tanah Grogot", "ISLAM", "Belum Menikah","Mahasiswa", "WNI");
		...
		System.out.println("1.Kelurahan Merjosari\n2.Kelurahan Tirto utomo");
		System.out.println("\nMasukkan Pilihan : ");
		i = input.nextInt();
